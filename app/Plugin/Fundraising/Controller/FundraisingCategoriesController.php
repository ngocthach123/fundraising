 ...
 */
class FundraisingCategoriesController extends FundraisingAppController {
    ...
    public function admin_create() {
        ...
        $headers = $this->Category->find('list', array('conditions' => array('Category.type' => 'Fundraising', 'Category.header' => 1), 'fields' => 'Category.name'));
        $headers[0] = '';
