...
?>
    ...
    <div class="activity_right ">
        <div class="activity_header">
            <a target="_blank" class="feed_title" href="<?php echo $this->request->base ?>/topics/view/<?php echo $campaign['Campaign']['id'] ?>/<?php echo seoUrl($campaign['Campaign']['title']) ?>"><b><?php echo h($campaign['Campaign']['title']) ?></b></a>
        </div>
