...
<div class="bar-content full_content p_m_10">
    <div class="content_center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                        <li>
                            ...
                            'title' => __d('fundraising', 'Invite Friends'),
                            'innerHtml'=> __d('fundraising', 'Invite Friends'),
                            ));
                            ?>
                        </li>
      ...
      $this->MooPopup->tag(array(
                            ...
                            'title' => __d('fundraising', 'Report Campaign'),
                            'innerHtml'=> __d('fundraising', 'Report Campaign'),
                            ));
                            ?>
                        </li>
                    </ul>
            ...
            <div class="post_header">
                <div><span><?php echo __d('fundraising','Created by:');?> </span><?php echo $this->Moo->getName($campaign['User']);?></div>
                <div><span><?php echo __d('fundraising','Target:');?> </span><?php echo $campaign['Campaign']['target_amount'] ? $currency['Currency']['symbol'].$campaign['Campaign']['target_amount'] : __d('fundraising','Unlimited');?></div>
                <div><span><?php echo __d('fundraising','Total raised:');?></span> <?php echo $currency['Currency']['symbol'].$campaign['Campaign']['raised_amount'];?></div>
                <div><span><?php echo __d('fundraising','Donations accepted util:');?></span>
                ...
                <a class="btn-action btn" href="<?php echo $this->request->base .'/fundraisings/donate/'.$campaign['Campaign']['id']?>"><?php echo __d('fundraising','Donate now');?> </a>
                <?php endif;?>
            </div>
            ...
            <div class="extra_info"><?php echo __d('fundraising', 'Posted in')?> <a href="<?php echo $this->request->base?>/fundraisings/index/<?php echo $campaign['Campaign']['category_id']?>/<?php echo seoUrl($campaign['Category']['name'])?>"><strong><?php echo $campaign['Category']['name']?></strong></a> <?php echo $this->Moo->getTime($campaign['Campaign']['created'], Configure::read('core.date_format'), $utz)?></div>
